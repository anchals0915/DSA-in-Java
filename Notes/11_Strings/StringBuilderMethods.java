...
public class StringBuilderMethods {
    public static void main(String[] args) {
        ...
        // char charAt(int index): This method returns the char 
        // value in this sequence at the specified index.
        builder.append("Anchal Singh") ; 
        System.out.println(builder.charAt(3));
        
        // int codePointAt(int index): This method returns the 
        // character (Unicode code point) at the specified index.
        System.out.println(builder.codePointAt(3));
